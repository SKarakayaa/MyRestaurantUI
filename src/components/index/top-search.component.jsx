...
import { selectAreUserOrdersFetching } from "../../redux/main/main.reselect";
    ...
    <section className="pt-5 pb-5 homepage-search-block position-relative">
      ...
      <Container>
        <Row className="d-flex align-items-center">
            ...
            <div className="homepage-search-title">
              <h1 className="mb-2 font-weight-normal">
                <span className="font-weight-bold">
                  <Translate>Find Awesome Deals</Translate>
                </span>
              </h1>
          ...
          <Col md={4}>
            {!areUserOrdersFetching && AuthHelper.IsLogin() && (
              <CurrentOrders />
            )}
          </Col>
        </Row>
...
const mapStateToProps = createStructuredSelector({
  ...
  areUserOrdersFetching: selectAreUserOrdersFetching,
});
